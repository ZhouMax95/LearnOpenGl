...
Camera camera(glm::vec3(-2.4f, 2.6f, -4.0f));
...
int main() {
	...
	Shader lightingShader("Shader/lightingShader2_3.vs", "Shader/lightingShader2_3.fs");
	Shader lampShader("Shader/lampShader2_3.vs", "Shader/lampShader2_3.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setVec3("light.ambient", 1,1,1);
