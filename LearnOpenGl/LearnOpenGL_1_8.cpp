...
https://learnopengl-cn.github.io/01%20Getting%20started/06%20Textures/#
	...
	glm::vec3 cubePosition[] = {
		...
		glm::vec3(-2.7f,3.5f,-7.5f),
		glm::vec3(4.3f,-2.5f,-3.5f),
		glm::vec3(4.5f,-4.5f,-6.5f),
	};
...
void processInput(GLFWwindow *window) {
	...
	float curretFrame = glfwGetTime();
	deltaTime = curretFrame - lastFrame;
	lastFrame = curretFrame;
